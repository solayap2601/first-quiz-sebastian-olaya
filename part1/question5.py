...
ALTER TABLE animals ADD favorite_food_id interger;
ALTER TABLE people ADD favorite_food_id interger;
"""
...
FROM animals
JOIN favorite_foods ON animals.favorite_food_id = food_id
WHERE vegetarian == 1;
"""